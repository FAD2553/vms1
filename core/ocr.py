...
try:
    ...
    import pytesseract
    # Définir le chemin de Tesseract sur Windows
...
def extract_cnib_info(image_path):
    """
    Extrait les informations de l'image de la CNIB.
    Correspond strictement à demo_ocr/test_ocr.py.
    """
    ...
    try:
        ...
        if cni_match:
            ...
            # Expression régulière de secours de la passe 1
            for line in lines_pass1:
