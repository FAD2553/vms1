...
class Visiteur(models.Model):
    ...
    motif_archivage = models.TextField(blank=True, null=True, verbose_name="Motif de l'archivage")
...
class Visite(models.Model):
    ...
    motif = models.CharField(max_length=255, verbose_name="Motif de la visite", blank=True, null=True)
...
ACTION_CHOICES = [
    ...
    ('DECONNEXION_AUTO', 'Déconnexion automatique'),
    ...
    ('ACTIVER_2FA', 'Activation 2FA'),
    ('DESACTIVER_2FA', 'Désactivation 2FA'),
    ('CONNEXION_2FA_ECHEC', 'Échec de connexion 2FA'),
]
